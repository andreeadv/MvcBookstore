...
namespace MvcBookstore.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Author,ReleaseDate,Genre,Price")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Author,ReleaseDate,Genre,Price")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
